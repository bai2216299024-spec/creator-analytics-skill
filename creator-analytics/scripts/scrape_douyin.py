...
def scrape_douyin(cookie_file: str, output_dir: str, headless: bool, target_date_str: str) -> dict:
    """采集抖音内容数据"""
    result = {
        "platform": PLATFORM,
...
def main():
    ...
    if args.dry_run:
        ...
        result = scrape_douyin(args.cookie_file, args.output_dir, headless, target_date_str)
